...
class RegistroViewModel : ViewModel() {
    ...
    fun validarRegistro(usuario: String, email: String, password: String) {
        ...
        _errorPassword.value = when {
            ...
            password.length < 8 -> "La contraseña es demasiado corta"
            else -> null
        }

        _registroExitoso.value = _errorUsuario.value == null && 
